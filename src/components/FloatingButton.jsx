...
const FloatingButton = () => {
  return (
    <Link
      to={"https://wa.me/+6282125311402?text=I+Want+To+Order"}
      target="_blank"
      className="fixed bottom-6 right-10 bg-green-500 p-4 rounded-full flex items-center gap-3"
    >
      <svg
      ...
      <h2 className="font-semibold pr-1 text-white">Contact Us</h2>
    </Link>
  );
};
